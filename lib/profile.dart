  ...
  Widget build(BuildContext context) {
    return BlocBuilder<AppCubit,AppState>(
        builder:(context, state) {
          ...
          ControllerName.text=AppCubit.get(context).listUser[0].name!;
          ControllerEmail.text=AppCubit.get(context).listUser[0].email!;
          ControllerPhone.text=AppCubit.get(context).listUser[0].phone!;
          return Scaffold(
