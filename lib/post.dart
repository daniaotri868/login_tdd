...
import 'package:real_estate/widget/tabBarCars.dart';
import 'package:real_estate/widget/tabBarHouses.dart';
import 'package:real_estate/widget/tabBarLand.dart';
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Row(
                ...
                children: [
                  Text("انشر بوست ",style: TextStyle(fontSize: 15.sp)),
